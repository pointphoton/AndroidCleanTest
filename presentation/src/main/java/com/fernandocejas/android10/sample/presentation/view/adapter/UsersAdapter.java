...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder> {
  ...
  UsersAdapter(Context context) {
    LogUtil.logTest("constructor UsersAdapter(Context context)");
    this.layoutInflater =
  ...
  @Override public UserViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    LogUtil.logTest("onCreateViewHolder");
  ...
  public void setUsersCollection(Collection<UserModel> usersCollection) {
    LogUtil.logTest("setUsersCollection(Collection<UserModel> usersCollection) ");
  ...
  public void setOnItemClickListener (OnItemClickListener onItemClickListener) {
    LogUtil.logTest("void setOnItemClickListener (OnItemClickListener onItemClickListener) ");
    this.onItemClickListener = onItemClickListener;
  }

  private void validateUsersCollection(Collection<UserModel> usersCollection) {
    LogUtil.logTest("void validateUsersCollection(Collection<UserModel> usersCollection)");

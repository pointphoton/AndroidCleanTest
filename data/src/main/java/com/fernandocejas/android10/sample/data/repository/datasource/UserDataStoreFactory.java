...
import com.fernandocejas.android10.sample.domain.LogUtil;
...
public class UserDataStoreFactory {
  ...
  public UserDataStore create(int userId) {
    ...
    LogUtil.logTest("UserDataStoreFactory create(int userId)");
    if (!this.userCache.isExpired() && this.userCache.isCached(userId)) {
      LogUtil.logTest("UserDataStoreFactory DiskUserDataStore(this.userCache)");
      userDataStore = new DiskUserDataStore(this.userCache);
    } else {
      LogUtil.logTest("UserDataStoreFactory createCloudDataStore()");

...
public class UserEntityDataMapper {
  ...
  public User transform(UserEntity userEntity) {
    LogUtil.logTest("UserEntityDataMapper [User] transform(UserEntity userEntity)");
    User user = null;
    if (userEntity != null) {
  ...
  public List<User> transform(Collection<UserEntity> userEntityCollection) {
    LogUtil.logTest("UserEntityDataMapper [List<User>] transform(Collection<UserEntity> userEntityCollection");
